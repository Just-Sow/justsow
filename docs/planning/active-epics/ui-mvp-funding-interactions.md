...
- “Review Basket” currently closes the Basket summary only; checkout and allocation are not implemented
...
- visitors can add projects to the Basket and review project names, amounts, and total
- visitors can remove entries or clear the demo Basket
