...
This directory is the canonical documentation area for JustSow.
...
- Code is authoritative for what has actually been implemented.
- `product/current/` is authoritative for the latest agreed product direction.
- `product/planned/` is not authoritative for implementation decisions.
